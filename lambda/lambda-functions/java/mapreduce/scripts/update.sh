cd ..
aws lambda update-function-configuration --function-name zzmae-java-map --description "`date`"
aws lambda update-function-configuration --function-name zzmae-java-reduce --description "`date`"

...
class V8_EXPORT HeapStatistics {
 public:
  ...
  // <zzm>
  size_t zzm_gc_cpu_cost() { return zzm_gc_cpu_cost_; }
  size_t zzm_gc_memory_reclaimed() { return zzm_gc_memory_reclaimed_; }
  // </zzm>
 ...
 private:
  ...
  // <zzm>
  size_t zzm_gc_cpu_cost_;
  size_t zzm_gc_memory_reclaimed_;
  // </zzm>
...
class V8_EXPORT Isolate {
 public:
  ...
  // <zzm>
  void ZZMReclaimMemory();
  void ZZMRestoreMemory();
  // </zzm>

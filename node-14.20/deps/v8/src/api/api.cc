...
void Isolate::GetHeapStatistics(HeapStatistics* heap_statistics) {
  ...
  // <zzm>
  heap_statistics->zzm_gc_memory_reclaimed_ = heap->ZZMGcMemoryReclaimed();
  heap_statistics->zzm_gc_cpu_cost_ = heap->ZZMGcCpuCost();
  // <zzm>
}
...
// <zzm>
void Isolate::ZZMReclaimMemory() {
  i::Isolate* isolate = reinterpret_cast<i::Isolate*>(this);
  isolate->heap()->ZZMReclaimMemory();
}

void Isolate::ZZMRestoreMemory() {
  i::Isolate* isolate = reinterpret_cast<i::Isolate*>(this);
  isolate->heap()->ZZMRestoreMemory();
}
// </zzm>
